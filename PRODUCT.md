...
**Majitel chaty (Tomáš Pavela)** zajišťuje pronájem i komunikaci se zájemci — web má
zjednodušit kontakt mezi zájemci a majitelem. Web prodává atmosféru a zážitek, ne jen postele.
...
rezervační dotaz (jméno, e-mail, telefon, termín, počet osob, poznámka) → e-mail majiteli,
...
- Po pár sekundách má jasno: kde to je (Bohemaland, Zlaté Hory), jak to vypadá, co to umí,
  kolik to stojí.
- Napíše rezervační dotaz bez obav — a majitel dostane e-mail se všemi detaily.
...
- **AI slop defaulty (2026)** — gradient text, kartové gridy s ikonami jako dekorace, „eyebrow" nad každou sekcí, číslované `01/02/03` scaffolding, hero-metric šablona, dřevěné texture pozadí. Plný seznam v `impeccable/SKILL.md`. (Pozn.: teplý krém jako signature surface zde povolen je — viz `DESIGN.md` §2, Warm Surface Rule.)
...
4. **Pravdivost materiálů.** Barvy a typografie evokují dřevo, kámen, zlato večerního světla, sníh — skutečné materiály a světlo místa, ne pastelové „přírodní" aproximace.

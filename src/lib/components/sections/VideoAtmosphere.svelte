<script lang="ts">
	// Video sekce — distill. Žádné další obsahové proměnné nepotřebujeme.
</script>
...
<section class="relative flex min-h-[60svh] items-end overflow-hidden bg-[var(--color-dark-deep)] md:min-h-[85svh]">
	<video
		...
		playsinline
		preload="metadata"
		aria-label="Atmosféra chaty Zlaté Hory"
	>
		<source src="/video/cabin-atmosphere.mp4" type="video/mp4" />
	</video>
